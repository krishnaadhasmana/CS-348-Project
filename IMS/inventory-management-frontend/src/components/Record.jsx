...
export default function Record() {
  ...
  return (
    <>
      ...
      >
        <input className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-slate-900/10 pb-12 md:grid-cols-2"
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-slate-900/10 pb-12 md:grid-cols-2">
          <select
            ...
            className="grid grid-cols-1 gap-x-8 gap-y-10 border-slate-900/10 md:grid-cols-2"
            required
          >
              ...
              <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-slate-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                  <input
                    ...
                    onChange={(e) => updateForm({ quantitySold: e.target.value })}
                    required
                  />
                </div>
              </div>
